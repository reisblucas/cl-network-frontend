...
export function LandingRoute() {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden bg-[oklch(0.98_0.005_264)] px-6">
        {/* Minimal network motif — floating nodes */}
        ...
        <main className="relative z-10 flex max-w-2xl flex-col items-center text-center">
          <span className="mb-4 text-xs font-medium uppercase tracking-[0.2em] text-[oklch(0.5_0.1_264)]">
            People Network
          </span>
          <h1 className="text-5xl font-semibold tracking-tight text-[oklch(0.2_0.02_264)] sm:text-6xl md:text-7xl">
            Where people
            <br />
            <span className="text-[oklch(0.55_0.18_45)]">connect.</span>
          </h1>
          <p className="mt-6 max-w-md text-base text-[oklch(0.45_0.02_264)]/80 sm:text-lg">
